          ...
          <Grid container rowSpacing={10} columnSpacing={12}>
            ...
            <Grid size={{ xs: 12, sm: 3, lg: 2 }}>
              ...
              <div className='flex flex-col gap-4'>
                ...
                <Typography component={Link} href='/dashboards/crm' color='white' className='opacity-[0.78]'>
                  Admin Dashboards
                </Typography>
                <Typography component={Link} href='/front-pages/landing-page' color='white' className='opacity-[0.78]'>
                  UI Kits
      ...
      <div className='bg-[#211B2C]'>
        ...
        >
          <Typography className='text-white' variant='body2'>
            ...
            <span>{` by `}</span>
            <Link
              href='https://www.linkedin.com/in/salman-khan-54b1472b7/'
              target='_blank'
          ...
          <div className='flex gap-1.5 items-center'>
            <IconButton component={Link} size='small' href='https://github.com/SalmanOkz' target='_blank'>
            ...
            <IconButton
              ...
              size='small'
              href='
https://x.com/m_salman_okz?t=m5quDgBZ63i9zlQlkSFYaw&s=09'
              target='_blank'
            >
